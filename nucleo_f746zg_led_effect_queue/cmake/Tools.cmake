...
function(add_clang_tidy_to_target target)
    ...
    message("Here is tidy src:" ${TARGET_SOURCES})
    ...
    if(CLANGTIDY)
        if(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
            ...
            add_custom_target(
                ...
                COMMAND
                    ${Python3_EXECUTABLE}
                    ${CMAKE_SOURCE_DIR}/Tools/clang-tidy/run-clang-tidy.py
                    ${TARGET_SOURCES}
                    -config-file=${CMAKE_SOURCE_DIR}/Tools/clang-tidy/.clang-tidy
                    -extra-arg-before=-std=${CMAKE_C_STANDARD}
                    -extra-arg=--target=arm-none-eabi
                    -extra-arg=-I/mnt/backup/toolchains/arm-gnu-toolchain-12.3.rel1-x86_64-arm-none-eabi/arm-none-eabi/include
                    -extra-arg=--sysroot=/mnt/backup/toolchains/arm-gnu-toolchain-12.3.rel1-x86_64-arm-none-eabi/arm-none-eabi/include
                    -extra-arg=-mcpu=cortex-m7
                    -extra-arg=--specs=nano.specs
                    -extra-arg=-mthumb
                    -header-filter="\(Core/Inc|src|app\)\/*.\(h|hpp\)"
                    -p=${CMAKE_BINARY_DIR}
...
function(add_clangtidy_to_target)
